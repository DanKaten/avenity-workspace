...
- Temporary / no-memory / logged-out session
- Exact query visible
- Date and time visible
- Market / location visible
- Which engine (Gemini, AI Mode, ChatGPT, Perplexity, Grok)
- Reproduce it live once to confirm
- Note who was named instead — or that the client was absent
